...
public class Complex {
    ...
    public Complex add(Complex b) {
        // You need to fill in this method.
        Complex a = new Complex(x+b.getReal(), y+b.getImag());
        return a;
    }
    ...
    public Complex multiply(double alpha) {
        // You need to fill in this method.
        Complex a = new Complex(x*alpha, y*alpha);
        return a;
    }
    ...
    public Complex multiply(Complex b) {
        // You need to fill in this method.
        Complex a = new Complex(x*b.getReal()-y*b.getImag(), x*b.getImag()+y*b.getReal());
        return a;
    }
    ...
    public Complex divide(Complex b) {
        // You need to fill in this method.
        double q= b.abs2();
        Complex a = new Complex((x*b.getReal()+y*b.getImag())/q, (y*b.getReal()-x*b.getImag())/q);
        return a;
    }
    ...
    public static void main(String[] args) {
        ...
        Complex D = new Complex(0.9999999999999994,-4.556244717939637E-16);
        Complex E = new Complex(1.0000000089100063,-2.5568132902702742E-8);
        ...
        System.out.println((D.add(E.minus())).abs());
    }
}